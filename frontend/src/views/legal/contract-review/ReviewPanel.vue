...
.review-panel{width:400px;min-width:400px;height:100%;display:flex;flex-direction:column;background:#fff;border-left:1px solid #deded9;color:#191917;}
.review-panel__header{min-height:72px;padding:15px 20px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #e5e5e0;box-sizing:border-box;.eyebrow{font-size:10px;letter-spacing:.11em;text-transform:uppercase;color:#8a8a83;}h2{margin:3px 0 0;font-size:16px;font-weight:650;}}
.review-panel__actions{display:flex;align-items:center;gap:8px}.rerun-button{height:28px;display:inline-flex;align-items:center;gap:4px;padding:0 8px;border:1px solid #d8d8d2;border-radius:4px;background:#fff;color:#4f4f49;font-size:10px;font-weight:650;cursor:pointer;&:hover{border-color:#aaa9a2;color:#171715}&:disabled{opacity:.45;cursor:not-allowed}}
.status-dot{padding:4px 8px;border-radius:4px;background:#efefec;font-size:11px;color:#5e5e58;&:before{content:'';display:inline-block;width:6px;height:6px;border-radius:50%;margin-right:5px;background:#9b9b94;}&--analyzing:before,&--reviewing_clauses:before{background:#8c6e31;animation:pulse 1.4s infinite;}&--completed:before{background:#48705b;}&--failed:before{background:#9a473c;}}
.review-setup{padding:24px 20px;display:flex;flex-direction:column;gap:20px;.review-setup__intro{display:flex;gap:10px;padding-bottom:18px;border-bottom:1px solid #ededE9;color:#3e624e;strong{font-size:14px;color:#191917;}p{margin:5px 0 0;font-size:12px;line-height:1.5;color:#71716b;}}label{display:flex;flex-direction:column;gap:7px;font-size:11px;font-weight:650;color:#5e5e58;text-transform:uppercase;letter-spacing:.05em;}select{height:38px;padding:0 10px;border:1px solid #d7d7d1;border-radius:5px;background:#fff;color:#191917;font:inherit;text-transform:none;letter-spacing:0;}}.review-setup__actions{display:flex;gap:8px;align-items:center}.review-setup__actions .primary-action{flex:1;margin:0}.cancel-config{height:40px;padding:0 13px;border:1px solid #d4d4ce;border-radius:5px;background:#fff;color:#565650;font-weight:600;cursor:pointer;&:disabled{opacity:.5;cursor:not-allowed}}
.primary-action{height:40px;border:0;border-radius:5px;background:#171715;color:#fff;font-weight:650;cursor:pointer;&:disabled{background:#c8c8c2;cursor:not-allowed;}}
.review-progress{padding:13px 20px;border-bottom:1px solid #e5e5e0;background:#fafaf8;font-size:12px;.review-progress__row{display:flex;justify-content:space-between}.review-progress__track{height:3px;margin-top:9px;background:#e1e1dc;i{display:block;height:100%;background:#6f644d;transition:width .4s;}}p{margin:8px 0 0;color:#7a7a73;font-size:11px;}}
.review-error{margin:14px 20px;padding:13px;border:1px solid #e5c7c2;background:#fffafa;border-radius:5px;color:#873d34;p{font-size:12px;}button{border:1px solid #b46b61;background:#fff;color:#873d34;border-radius:4px;padding:6px 10px;cursor:pointer;}}
.review-tabs{height:43px;display:flex;padding:0 13px;border-bottom:1px solid #e5e5e0;button{position:relative;padding:0 8px;border:0;background:transparent;color:#73736d;font-size:12px;cursor:pointer;&.active{color:#111;font-weight:650;&:after{content:'';position:absolute;left:8px;right:8px;bottom:-1px;height:2px;background:#111;}}span{margin-left:4px;color:#999;}}}
.review-panel__content{min-height:0;flex:1;overflow:auto;padding:18px 20px;}
.overall-risk{display:flex;justify-content:space-between;align-items:center;padding-bottom:15px;border-bottom:1px solid #e9e9e5;font-size:12px;color:#707069}.summary{font-size:13px;line-height:1.65;color:#343431}.risk-counts{display:grid;grid-template-columns:repeat(3,1fr);margin:18px 0;border:1px solid #e3e3de;border-radius:5px;div{padding:12px;border-right:1px solid #e3e3de;&:last-child{border:0}strong,span{display:block}strong{font-size:18px}span{margin-top:2px;font-size:10px;color:#7c7c75}}}.overview-pane dl{dt{font-size:10px;color:#888;text-transform:uppercase}dd{margin:5px 0;font-size:13px}}.key-recommendations h3{font-size:12px}.key-recommendations ol{padding-left:18px;font-size:12px;line-height:1.6}
.issue{padding:15px 0;border-bottom:1px solid #e5e5e0;cursor:pointer;&.selected{margin:0 -10px;padding:15px 10px;background:#f7f7f4;border-radius:5px}.issue__top{display:flex;align-items:center;gap:8px;color:#7b7b74;font-size:10px}h3{margin:9px 0 6px;font-size:13px}p{margin:0;font-size:12px;line-height:1.55;color:#55554f}details{margin-top:10px;summary{font-size:11px;color:#777;cursor:pointer}blockquote{margin:7px 0 0;padding-left:10px;border-left:2px solid #d9d3c4;font-size:11px;line-height:1.5;color:#65655f}}.issue__suggestion{margin-top:11px;padding:10px;background:#f5f5f2;border-radius:4px;span{font-size:10px;font-weight:650;text-transform:uppercase;color:#777}p{margin-top:5px}}.view-clause{margin-top:10px;padding:0;border:0;background:transparent;color:#2f5742;font-size:11px;font-weight:650;cursor:pointer}}
:deep(.risk-badge){display:inline-flex;padding:3px 6px;border-radius:3px;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;&.risk-badge--high{color:#8b3e34;background:#f6e8e5}&.risk-badge--medium{color:#80621d;background:#f5eedc}&.risk-badge--low{color:#376249;background:#e7f0ea}}
.clauses-pane button{width:100%;padding:12px 0;display:flex;align-items:center;justify-content:space-between;border:0;border-bottom:1px solid #e6e6e1;background:transparent;text-align:left;cursor:pointer;strong,span{display:block}strong{font-size:12px}span,em{margin-top:4px;color:#85857e;font-size:10px;font-style:normal}}
.suggestions-pane article{display:flex;gap:10px;padding:13px 0;border-bottom:1px solid #e6e6e1;cursor:pointer;strong{font-size:12px}p{margin:5px 0 0;font-size:12px;line-height:1.5;color:#5d5d57}}
.empty-results{padding:36px 10px;text-align:center;color:#888881;font-size:12px}@keyframes pulse{50%{opacity:.35}}
</style>
