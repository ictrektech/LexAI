...
async function runBulkAction(action: 'archive' | 'restore') {
  ...
  const confirmKey = action === 'archive' ? 'smartArchive.bulkArchiveConfirm' : 'smartArchive.bulkRestoreConfirm'
