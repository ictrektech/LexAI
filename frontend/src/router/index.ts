  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'drafting',
          name: LEGAL_DOCUMENT_DRAFTING_ROUTE,
          component: () => import('../views/legal/DocumentDrafting.vue'),
          meta: { requiresInit: true, requiresAuth: true, legalWorkspace: true },
        },
        {
          path: 'drafting/:jobId',
          name: LEGAL_DOCUMENT_DRAFTING_DETAIL_ROUTE,
          component: () => import('../views/legal/document-drafting/DocumentDraftingDetail.vue'),
          meta: { requiresInit: true, requiresAuth: true, legalWorkspace: true },
        },
        {
          path: 'drafting/:jobId/debug',
          name: LEGAL_DOCUMENT_DRAFTING_DEBUG_ROUTE,
          component: () => import('../views/legal/document-drafting/DocumentDraftingDebug.vue'),
          meta: { requiresInit: true, requiresAuth: true, legalWorkspace: true },
        },
      ],
    },
