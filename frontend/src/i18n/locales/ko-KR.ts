export default {
  ...
  smartArchive: {
    selectAll: '현재 목록 전체 선택', selectedCount: '{count}개 선택됨', bulkArchive: '선택 항목 보관', bulkRestore: '선택 항목 복원', bulkDelete: '휴지통으로 이동', bulkArchiveConfirm: '선택한 문서 {count}개를 보관하시겠습니까?', bulkRestoreConfirm: '선택한 문서 {count}개를 복원하시겠습니까?', bulkDeleteConfirm: '선택한 문서 {count}개를 휴지통으로 이동하시겠습니까? 관련 알림도 취소됩니다.', bulkActionSuccess: '문서 {count}개를 처리했습니다.', bulkActionPartial: '{succeeded}개 처리, {failed}개 실패했습니다. 목록을 새로 고쳐 확인하세요.', bulkActionFailed: '일괄 작업에 실패했습니다.',
