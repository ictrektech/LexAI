export default {
  ...
  documentDrafting: {
    preview: '페이지 미리보기',
    debug: { open: '실행 진단', back: '작업 상세로 돌아가기', title: '실행 진단', eyebrow: '관측 및 모드 평가', loading: '실행 진단을 불러오는 중…', loadFailed: '실행 진단을 불러오지 못했습니다', compare: '모드 비교', mode: '실행 모드', model: '계획 모델', duration: '총 소요 시간', stageUnit: '단계', notRecorded: '이 작업을 만들 때 전체 실행 추적이 기록되지 않았습니다. 기존 Plan, 작업 및 결과는 계속 표시됩니다.', timeline: '단계 타임라인', autoRefreshing: '2초마다 자동 새로고침', terminal: '작업 종료 상태', attempt: '{count}번째 시도', sourceEngine: '소스 엔진', characters: '원본 문자 수', truncated: '잘림 여부', yes: '예', no: '아니요', loadSnapshot: '텍스트 스냅샷 불러오기', expandToLoad: '요청할 때만 텍스트를 불러옵니다', operationUnit: '개 작업', kind: '유형', result: '결과', planJson: 'Plan JSON', resultAnalysis: '결과 분석', artifactUnit: '개 결과', artifacts: '결과 요약', validation: '검증 요약', loadDiff: 'source / clean 텍스트 Diff 불러오기', loadingDiff: 'Diff 생성 중…', diffNotRecorded: 'clean 텍스트 스냅샷이 기록되지 않았습니다.', comparison: '모드 비교', newComparison: '새 비교', strategy: '비교 전략', sourceTask: '원본 작업', openTask: '진단 열기', noComparison: '생성된 모드 비교가 없습니다.', compareTitle: '같은 입력으로 실행 모드 비교', compareHint: '소스 파일, 지시문 및 모델은 동일하게 유지됩니다.', replanHint: '각 모드가 Inspect 후 자체 Plan을 만듭니다.', lockedHint: '원본 Plan을 재사용해 Worker만 비교하며 호환되지 않으면 전체 요청을 거부합니다.', modes: '실행 모드', startComparison: '비교 시작', startingComparison: '생성 중…', compareFailed: '모드 비교를 만들지 못했습니다.', blobLoadFailed: '보호된 디버그 내용을 불러오지 못했습니다.' },
    eyebrow: '법률 워크스페이스', title: '계약서 작성', subtitle: 'DOCX를 업로드하고 자연어로 검토 가능한 수정안을 생성합니다.', newTask: '새 작성 작업', file: 'DOCX 파일', instruction: '수정 요청', instructionPlaceholder: '예: 송장 수령 후 30일 이내 지급으로 변경하고 댓글을 추가하세요.', mode: '엔진 모드', modeHint: 'Hybrid는 수정 표시를 만들고 검증 및 미리보기를 수행합니다.', officeCliLimit: 'OfficeCLI는 clean 결과만 지원하며 댓글과 변경 내용 추적을 지원하지 않습니다.', start: '생성 시작', submitting: '제출 중…', refresh: '새로 고침', capabilities: 'Worker 기능', capabilityHint: 'XLSX/PPTX는 아직 지원되지 않습니다.', tasks: '작업', taskCount: '작업 {count}개', loadingTasks: '작업을 불러오는 중…', empty: '작성 작업이 없습니다', emptyDescription: '작업을 만들면 상태와 결과가 여기에 표시됩니다.', noMatches: '필터와 일치하는 작업이 없습니다', searchPlaceholder: '파일 이름 또는 수정 요청 검색', dateFrom: '시작 날짜', dateTo: '종료 날짜', modeFilter: '엔진 모드로 필터링', allModes: '모든 모드', allStatuses: '모든 상태', selectedStatuses: '상태 {count}/5', clearFilters: '필터 지우기', document: '문서', statusLabel: '상태', outputs: '결과', updated: '업데이트', artifactCount: '결과 {count}개', details: '상세 보기', taskDetails: '작업 상세', taskId: '작업 ID', copyTaskId: '작업 ID 복사', taskIdCopied: '작업 ID가 복사되었습니다', backToTasks: '작업 목록으로 돌아가기', loadingDetail: '작업 상세를 불러오는 중…', detailLoadFailed: '작업 상세를 불러오지 못했습니다', previewReady: '문서 미리보기가 준비되었습니다', previewUnavailable: '문서 미리보기 없음', previewHint: '필요할 때 render 결과를 불러옵니다.', previewUnavailableHint: '이 작업에는 미리볼 render 결과가 없습니다.', loadPreview: '미리보기 불러오기', previewLoadFailed: '미리보기를 불러오지 못했습니다.', operationCount: '작업 {count}개', fileInfo: '파일 정보', fileSize: '파일 크기', timeline: '타임라인', created: '생성됨', started: '시작됨', completed: '완료됨', errorDetails: '오류 상세', download: '다운로드', noArtifacts: '사용 가능한 결과 없음', loadingPreview: '미리보기 로드 중…', operations: '실행 작업', noOperations: '작업 기록 없음', retry: '다시 시도', loadFailed: '작업을 불러오지 못했습니다.', submitFailed: '작업을 생성하지 못했습니다.', downloadFailed: '결과를 다운로드하지 못했습니다.', cancel: '작업 취소', cancelFailed: '작업을 취소하지 못했습니다.', status: { queued: '대기 중', running: '실행 중', completed: '완료', failed: '실패', cancelled: '취소됨' }
  },
  smartArchive: {
    deleteNotification: '알림 삭제', deleteNotificationConfirm: '이 알림을 삭제하시겠습니까?', notificationUpdateFailed: '알림 상태를 업데이트하지 못했습니다.', notificationDeleteFailed: '알림을 삭제하지 못했습니다.',
    selectAll: '현재 목록 전체 선택', selectedCount: '{count}개 선택됨', bulkArchive: '선택 항목 보관', bulkRestore: '선택 항목 복원', bulkDelete: '영구 삭제', bulkArchiveConfirm: '선택한 문서 {count}개를 보관하시겠습니까?', bulkRestoreConfirm: '선택한 문서 {count}개를 복원하시겠습니까?', bulkDeleteConfirm: '선택한 문서 {count}개를 영구 삭제하시겠습니까? 복구할 수 없으며 관련 알림도 취소됩니다.', bulkActionSuccess: '문서 {count}개를 처리했습니다.', bulkActionPartial: '{succeeded}개 처리, {failed}개 실패했습니다. 목록을 새로 고쳐 확인하세요.', bulkActionFailed: '일괄 작업에 실패했습니다.',
    bulkDeleteReminders: '알림 일괄 삭제', bulkDeleteRemindersConfirm: '선택한 {count}개의 알림을 삭제하시겠습니까?', bulkDeleteRemindersActiveConfirm: '선택한 알림 중 {active}개가 예약되어 있습니다. 삭제하면 향후 알림이 즉시 중지됩니다. 계속하시겠습니까?', bulkDeleteRemindersSuccess: '{count}개의 알림을 삭제했습니다.', bulkIgnoreCandidates: '선택 항목 무시', bulkIgnoreCandidatesConfirm: '선택한 {count}개의 항목을 무시하시겠습니까? 알림은 생성되지 않지만 기록은 보존됩니다.', bulkIgnoreCandidatesSuccess: '{count}개의 항목을 무시했습니다.',
    eyebrow: '아카이브', title: '계약 스마트 아카이브', subtitle: '문서, 고객 정보와 중요한 날짜를 한곳에서 관리합니다.', importFiles: '파일 가져오기', importing: '가져오는 중', importStarted: '가져오기를 시작했습니다.', importFailed: '가져오기에 실패했습니다.', invalidFiles: '지원하지 않는 파일을 건너뛰었습니다. PDF, Word, Excel, JPG, PNG, WEBP를 지원합니다.', loading: '로드 중…', loadFailed: '아카이브를 불러오지 못했습니다.', searchFailed: '검색에 실패했습니다.', documents: '문서', documentCount: '문서 {count}개', documentsDescription: '계약, 대여 계약, 출고 문서 및 원문 증거. 이미지 OCR을 지원합니다.', customers: '고객', customersDescription: '문서에서 정규화한 고객.', reminders: '알림', remindersDescription: '중요한 날짜를 확인한 뒤 알림을 만들고 활성화합니다.', candidatesTitle: '확인할 항목', candidatesDescription: '감지된 일정은 제안일 뿐이며 자동으로 알림을 만들지 않습니다.', noCandidates: '확인할 항목이 없습니다', candidateNeedsReview: '필드를 먼저 검토하세요', candidateReview: '알림 확인', createReminder: '알림 만들기', reminderCreated: '알림이 만들어졌습니다. 준비되면 활성화하세요.', offsetDays: '며칠 전', reminderTime: '알림 시간', assignee: '담당자', assigneeDefault: '기본 담당자', eventDate: '이벤트 날짜', suggestedReminderDate: '권장 알림 날짜', returnDue: '반납 예정일', cancel: '취소', reviewQueue: '검토 대기열', reviewQueueDescription: '확인이 필요한 필드와 문서 연결.', searchPlaceholder: '검색어나 협약 번호를 입력하세요', searchAction: '검색', dateFrom: '가져온 시작 날짜', dateTo: '가져온 종료 날짜', typeFilter: '문서 유형으로 필터링', allTypes: '전체 유형', allStatuses: '모든 상태', selectedStatuses: '상태 {count}/7', archiveView: '아카이브 범위', currentDocuments: '현재 문서', archivedDocuments: '보관 문서', showArchived: '보관 문서 표시', clearFilters: '필터 지우기', noMatchingDocuments: '필터와 일치하는 문서가 없습니다.', loadMore: '더 불러오기', loadedCount: '{loaded}/{total}개 로드됨', emptyDocuments: '문서가 없습니다', emptyDocumentsDescription: 'PDF, Word, Excel, JPG, PNG 또는 WEBP를 가져오면 필드를 추출합니다.', noEntities: '기록 없음', noReminders: '만들어진 알림이 없습니다', notifications: '알림', markRead: '읽음 처리', refresh: '새로 고침', reidentify: '다시 인식', document: '문서', type: '유형', customer: '고객', relatedParty: '관련 주체', status: '상태', updated: '업데이트', archive: '보관', archiveConfirm: '“{name}”을 보관하시겠습니까?', restore: '복원', restoreConfirm: '“{name}”을 복원하시겠습니까?', restoreFailed: '아카이브를 복원하지 못했습니다.', delete: '삭제', deleteConfirm: '“{name}”을 삭제하시겠습니까? 휴지통으로 이동합니다.', deleteFailed: '아카이브를 삭제하지 못했습니다.', documentDetail: '문서 상세', fileName: '파일 이름', fileSize: '파일 크기', importedAt: '가져온 시간', errorDetails: '오류 상세', openOriginal: '원문 열기', agreementNumber: '협약 번호', expiry: '만료일', amount: '금액', evidence: '필드 증거', noEvidence: '증거 없음', aliases: '별칭', manual: '수동', confidence: '신뢰도', noDueDate: '날짜 확인 필요', activate: '활성화', handle: '처리 완료', reminderFailed: '알림을 업데이트하지 못했습니다.', queueEmpty: '검토 대기열이 비어 있습니다', queueEmptyDescription: '낮은 신뢰도 필드가 표시됩니다.', noVerifiedFields: '확인 가능한 필드가 없습니다. 다시 인식하거나 수동으로 검토하세요.', documentTypes: { contract: '계약', loan_agreement: '대여 계약', outbound_order: '출고', return_order: '반납', renewal: '갱신', payment: '지급', delivery: '납품', other: '기타' }, extractionStatuses: { uploading: '업로드 중', parsing: '파싱 중', extracting: '추출 중', linking: '연결 중', needs_review: '검토 필요', completed: '완료', failed: '실패' }, reminderStatuses: { draft: '활성화 필요', active: '활성', snoozed: '연기됨', handled: '처리됨', canceled: '취소됨' }
  },
  platformApiKeys: {
    title: '플랫폼 API 키',
  ...
  settings: {
    ...
    sandbox: {
      ...
      recheck: '다시 검증',
      deepCheckIntro: '저장하기 전에 전체 검증을 한 번 실행할 수 있습니다. 임시 샌드박스를 만들어 스크립트를 실행하고 외부 통신까지 확인한 뒤 삭제합니다.',
      ...
      skipReasons: {
        ...
        environment_unavailable: '실행 환경을 사용할 수 없어 건너뜀',
