export default {
  ...
  smartArchive: {
    ...
    eyebrow: '아카이브', title: '계약 스마트 아카이브', subtitle: '문서, 고객 정보와 중요한 날짜를 한곳에서 관리합니다.', importFiles: '파일 가져오기', importing: '가져오는 중', importStarted: '가져오기를 시작했습니다.', importFailed: '가져오기에 실패했습니다.', invalidFiles: '지원하지 않는 파일을 건너뛰었습니다. PDF, Word, Excel, JPG, PNG, WEBP를 지원합니다.', loading: '로드 중…', loadFailed: '아카이브를 불러오지 못했습니다.', searchFailed: '검색에 실패했습니다.', documents: '문서', documentsDescription: '계약, 대여 계약, 출고 문서 및 원문 증거. 이미지 OCR을 지원합니다.', customers: '고객', customersDescription: '문서에서 정규화한 고객.', reminders: '알림', remindersDescription: '중요한 날짜를 확인한 뒤 알림을 만들고 활성화합니다.', candidatesTitle: '확인할 항목', candidatesDescription: '감지된 일정은 제안일 뿐이며 자동으로 알림을 만들지 않습니다.', noCandidates: '확인할 항목이 없습니다', candidateNeedsReview: '필드를 먼저 검토하세요', candidateReview: '알림 확인', createReminder: '알림 만들기', reminderCreated: '알림이 만들어졌습니다. 준비되면 활성화하세요.', offsetDays: '며칠 전', reminderTime: '알림 시간', assignee: '담당자', assigneeDefault: '기본 담당자', eventDate: '이벤트 날짜', suggestedReminderDate: '권장 알림 날짜', returnDue: '반납 예정일', cancel: '취소', reviewQueue: '검토 대기열', reviewQueueDescription: '확인이 필요한 필드와 문서 연결.', searchPlaceholder: '검색어나 협약 번호를 입력하세요', allTypes: '전체 유형', showArchived: '보관 문서 표시', emptyDocuments: '문서가 없습니다', emptyDocumentsDescription: 'PDF, Word, Excel, JPG, PNG 또는 WEBP를 가져오면 필드를 추출합니다.', noEntities: '기록 없음', noReminders: '만들어진 알림이 없습니다', notifications: '알림', markRead: '읽음 처리', refresh: '새로 고침', reidentify: '다시 인식', document: '문서', type: '유형', customer: '고객', relatedParty: '관련 주체', status: '상태', updated: '업데이트', archive: '보관', archiveConfirm: '“{name}”을 보관하시겠습니까?', restore: '복원', restoreConfirm: '“{name}”을 복원하시겠습니까?', restoreFailed: '아카이브를 복원하지 못했습니다.', delete: '삭제', deleteConfirm: '“{name}”을 삭제하시겠습니까? 휴지통으로 이동합니다.', deleteFailed: '아카이브를 삭제하지 못했습니다.', documentDetail: '문서 상세', openOriginal: '원문 열기', agreementNumber: '협약 번호', expiry: '만료일', amount: '금액', evidence: '필드 증거', noEvidence: '증거 없음', aliases: '별칭', manual: '수동', confidence: '신뢰도', noDueDate: '날짜 확인 필요', activate: '활성화', handle: '처리 완료', reminderFailed: '알림을 업데이트하지 못했습니다.', queueEmpty: '검토 대기열이 비어 있습니다', queueEmptyDescription: '낮은 신뢰도 필드가 표시됩니다.', noVerifiedFields: '확인 가능한 필드가 없습니다. 다시 인식하거나 수동으로 검토하세요.', documentTypes: { contract: '계약', loan_agreement: '대여 계약', outbound_order: '출고', return_order: '반납', renewal: '갱신', payment: '지급', delivery: '납품', other: '기타' }, extractionStatuses: { uploading: '업로드 중', parsing: '파싱 중', extracting: '추출 중', linking: '연결 중', needs_review: '검토 필요', completed: '완료', failed: '실패' }, reminderStatuses: { draft: '활성화 필요', active: '활성', snoozed: '연기됨', handled: '처리됨', canceled: '취소됨' }
  },
  platformApiKeys: {
    title: '플랫폼 API 키',
