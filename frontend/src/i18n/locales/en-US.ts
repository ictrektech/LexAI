export default {
  ...
  contractReview: {
    ...
    selectAll: 'Select all visible', selectedCount: '{count} selected', bulkArchive: 'Archive selected', bulkRestore: 'Restore selected', bulkDelete: 'Delete selected', bulkArchiveConfirm: 'Archive the selected {count} reviews?', bulkArchiveRunningConfirm: 'Archive {count} reviews? {running} running reviews will be skipped.', bulkRestoreConfirm: 'Restore the selected {count} reviews?', bulkDeleteConfirm: 'Permanently delete the selected {count} reviews and their documents?', bulkDeleteRunningConfirm: '{running} of the selected {count} reviews are still running. Deleting them immediately stops further review and result writes. Continue?', bulkActionSuccess: 'Processed {count} reviews.', bulkActionPartial: 'Processed {succeeded}; {failed} failed.', bulkActionFailed: 'The bulk action failed.',
  ...
  documentDrafting: {
    ...
    debug: { open: 'Execution diagnostics', back: 'Back to task details', title: 'Execution diagnostics', eyebrow: 'Observability and mode evaluation', loading: 'Loading execution diagnostics…', loadFailed: 'Could not load execution diagnostics', compare: 'Compare modes', mode: 'Engine mode', model: 'Planning model', duration: 'Total duration', stageUnit: 'stages', notRecorded: 'A complete execution trace was not recorded when this task was created. Existing plans, operations, and artifacts are still shown.', timeline: 'Stage timeline', autoRefreshing: 'Refreshing every 2 seconds', terminal: 'Task is terminal', attempt: 'Attempt {count}', sourceEngine: 'Source engine', characters: 'Original characters', truncated: 'Truncated', yes: 'Yes', no: 'No', loadSnapshot: 'Load text snapshot', expandToLoad: 'Text loads only on request', operationUnit: 'operations', kind: 'Kind', result: 'Result', planJson: 'Plan JSON', resultAnalysis: 'Result analysis', artifactUnit: 'artifacts', artifacts: 'Artifact summary', validation: 'Validation summary', loadDiff: 'Load source / clean text diff', loadingDiff: 'Building diff…', diffNotRecorded: 'No clean-text snapshot was recorded for this task.', comparison: 'Mode comparison', newComparison: 'New comparison', strategy: 'Strategy', sourceTask: 'Source task', openTask: 'Open diagnostics', noComparison: 'No mode comparison has been created.', compareTitle: 'Compare modes with the same input', compareHint: 'The source file, instruction, and model remain fixed.', replanHint: 'Each mode inspects the file and creates its own plan.', lockedHint: 'Reuse the original plan and compare workers only; incompatible requests are rejected atomically.', modes: 'Modes', startComparison: 'Start comparison', startingComparison: 'Creating…', compareFailed: 'Could not create the comparison.', blobLoadFailed: 'Could not load protected debug content.' },
    eyebrow: 'Legal workspace', title: 'Contract Drafting', subtitle: 'Upload a DOCX and generate reviewable edits from natural language.', newTask: 'New drafting task', file: 'DOCX file', instruction: 'Edit request', instructionPlaceholder: 'For example: change the payment term to 30 days after receipt of invoice and add a comment.', mode: 'Engine mode', modeHint: 'Hybrid lets Adeu create revisions, then OfficeCLI validates and previews the result.', officeCliLimit: 'OfficeCLI produces clean output only; comments and Track Changes are unsupported.', start: 'Generate', submitting: 'Submitting…', refresh: 'Refresh', capabilities: 'Worker capabilities', capabilityHint: 'XLSX/PPTX are not enabled yet. Missing workers do not stop other legal features.', tasks: 'Tasks', taskCount: '{count} tasks', loadingTasks: 'Loading tasks…', empty: 'No drafting tasks yet', emptyDescription: 'Task status and outputs will appear here after you create one.', noMatches: 'No tasks match these filters', searchPlaceholder: 'Search file names or edit requests', dateFrom: 'Start date', dateTo: 'End date', modeFilter: 'Filter by engine mode', allModes: 'All modes', allStatuses: 'All statuses', selectedStatuses: '{count} of 5 statuses', clearFilters: 'Clear filters', document: 'Document', statusLabel: 'Status', outputs: 'Outputs', updated: 'Updated', artifactCount: '{count} outputs', details: 'View details', taskDetails: 'Task details', taskId: 'Task ID', copyTaskId: 'Copy task ID', taskIdCopied: 'Task ID copied', backToTasks: 'Back to tasks', loadingDetail: 'Loading task details…', detailLoadFailed: 'Could not load task details', previewReady: 'Document preview is ready', previewUnavailable: 'No document preview', previewHint: 'Load the render artifact on demand.', previewUnavailableHint: 'This task has no render artifact to preview.', loadPreview: 'Load preview', previewLoadFailed: 'Could not load the preview.', operationCount: '{count} operations', fileInfo: 'File information', fileSize: 'File size', timeline: 'Timeline', created: 'Created', started: 'Started', completed: 'Completed', errorDetails: 'Error details', download: 'Download', noArtifacts: 'No outputs available', loadingPreview: 'Loading preview…', operations: 'Operations', noOperations: 'No operation records', retry: 'Retry', loadFailed: 'Could not load drafting tasks.', submitFailed: 'Could not create drafting task.', downloadFailed: 'Could not download the artifact.', cancel: 'Cancel task', cancelFailed: 'Could not cancel the task.', status: { queued: 'Queued', running: 'Running', completed: 'Completed', failed: 'Failed', cancelled: 'Cancelled' }
  },
  smartArchive: {
    deleteNotification: 'Delete notification', deleteNotificationConfirm: 'Delete this notification?', notificationUpdateFailed: 'Could not update the notification.', notificationDeleteFailed: 'Could not delete the notification.',
    bulkDeleteReminders: 'Delete reminders', bulkDeleteRemindersConfirm: 'Delete the selected {count} reminders?', bulkDeleteRemindersActiveConfirm: '{active} of the selected {count} reminders are scheduled. Deleting them stops future notifications immediately. Continue?', bulkDeleteRemindersSuccess: 'Deleted {count} reminders.', bulkIgnoreCandidates: 'Ignore selected', bulkIgnoreCandidatesConfirm: 'Ignore the selected {count} items? They will not create reminders, but their records will be retained.', bulkIgnoreCandidatesSuccess: 'Ignored {count} items.',
    eyebrow: 'Archive workspace', title: 'Contract Archive', subtitle: 'Preserve historical documents, customer information, and important dates.', importFiles: 'Import files', importing: 'Importing', importStarted: 'Import started.', importFailed: 'Import failed.', invalidFiles: 'Unsupported files were skipped. PDF, Word, Excel, JPG, PNG and WEBP are supported.', loading: 'Loading…', loadFailed: 'Could not load the archive.', searchFailed: 'Search failed.', documents: 'Documents', documentCount: '{count} documents', documentsDescription: 'Contracts, loan agreements, outbound orders and source evidence, including OCR from images.', customers: 'Customers', customersDescription: 'Customers normalized from historical documents.', reminders: 'Reminders', remindersDescription: 'Confirm a milestone before creating and activating a reminder.', candidatesTitle: 'Items to confirm', candidatesDescription: 'Detected milestones are suggestions only and never create reminders automatically.', noCandidates: 'No items to confirm', candidateNeedsReview: 'Review field first', candidateReview: 'Confirm reminder', createReminder: 'Create reminder', reminderCreated: 'Reminder created. Activate it when ready.', offsetDays: 'Days in advance', reminderTime: 'Reminder time', assignee: 'Assignee', assigneeDefault: 'Default assignee', eventDate: 'Event date', suggestedReminderDate: 'Suggested reminder date', returnDue: 'Return due', cancel: 'Cancel', reviewQueue: 'Review queue', reviewQueueDescription: 'Fields and document links that need human confirmation.', searchPlaceholder: 'Try “last year’s contract with Acme” or enter an agreement number', searchAction: 'Search', dateFrom: 'Imported from', dateTo: 'Imported to', typeFilter: 'Filter by document type', allTypes: 'All types', allStatuses: 'All statuses', selectedStatuses: '{count} of 7 statuses', archiveView: 'Archive scope', currentDocuments: 'Current documents', archivedDocuments: 'Archived documents', showArchived: 'Show archived', clearFilters: 'Clear filters', noMatchingDocuments: 'No archive documents match these filters.', loadMore: 'Load more', loadedCount: '{loaded} of {total} loaded', selectAll: 'Select all visible', selectedCount: '{count} selected', bulkArchive: 'Archive selected', bulkRestore: 'Restore selected', bulkDelete: 'Permanently delete', bulkArchiveConfirm: 'Archive the selected {count} documents?', bulkRestoreConfirm: 'Restore the selected {count} documents?', bulkDeleteConfirm: 'Permanently delete the selected {count} documents? They cannot be recovered and related reminders will be canceled.', bulkActionSuccess: 'Processed {count} documents.', bulkActionPartial: 'Processed {succeeded}; {failed} failed. Refresh to review the list.', bulkActionFailed: 'The bulk action failed.', emptyDocuments: 'No archive documents', emptyDocumentsDescription: 'Import PDF, Word, Excel, JPG, PNG or WEBP files to extract structured fields.', noEntities: 'No records', noReminders: 'No created reminders', notifications: 'Notifications', markRead: 'Mark read', refresh: 'Refresh', reidentify: 'Re-identify', document: 'Document', type: 'Type', customer: 'Customer', relatedParty: 'Related party', status: 'Status', updated: 'Updated', archive: 'Archive', archiveConfirm: 'Archive “{name}”?', restore: 'Restore', restoreConfirm: 'Restore “{name}”?', restoreFailed: 'Could not restore the archive record.', delete: 'Delete', deleteConfirm: 'Delete “{name}”? It will be moved to the trash.', deleteFailed: 'Could not delete the archive record.', documentDetail: 'Document detail', fileName: 'File name', fileSize: 'File size', importedAt: 'Imported', errorDetails: 'Error details', openOriginal: 'Open original', agreementNumber: 'Agreement number', expiry: 'Expiry', amount: 'Amount', evidence: 'Field evidence', noEvidence: 'No field evidence', aliases: 'Aliases', manual: 'Manual', confidence: 'Confidence', noDueDate: 'Date to confirm', activate: 'Activate', handle: 'Mark handled', reminderFailed: 'Could not update reminder.', queueEmpty: 'Review queue is empty', queueEmptyDescription: 'Low-confidence fields will appear here.', noVerifiedFields: 'No verifiable fields were found. Re-identify the document or review it manually.', documentTypes: { contract: 'Contract', loan_agreement: 'Loan agreement', outbound_order: 'Outbound order', return_order: 'Return order', renewal: 'Renewal', payment: 'Payment', delivery: 'Delivery', other: 'Other' }, extractionStatuses: { uploading: 'Uploading', parsing: 'Parsing', extracting: 'Extracting', linking: 'Linking', needs_review: 'Needs review', completed: 'Completed', failed: 'Failed' }, reminderStatuses: { draft: 'Needs activation', active: 'Active', snoozed: 'Snoozed', handled: 'Handled', canceled: 'Canceled' }
  },
  menu: {
