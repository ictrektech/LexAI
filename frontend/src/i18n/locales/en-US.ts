export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Welcome to ChatSwitch法律小助手',
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and ChatSwitch法律小助手 parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  knowledgeBase: {
    ...
    deleteSubmitted: 'Delete task submitted',
    batchDeleteSuccess: 'Deleted {count} documents',
    batchDeleteSubmitted: 'Submitted {count} document delete task(s)',
    ...
    reparseFailedDocumentsSuccess: 'Submitted {count} failed document(s) for reparse',
    ...
    downloadKnowledgeBaseSuccess: 'Started downloading {count} source file(s)',
    downloadKnowledgeBaseFailed: 'Failed to download KB documents',
    noDownloadableDocuments: 'No downloadable documents',
  ...
  graphSettings: {
    ...
    downloadTemplate: 'Download Current Template',
    ...
    templateUploadFailed: 'Failed to upload template, please check the JSON format',
  ...
  initialization: {
    ...
    welcome: 'Welcome to ChatSwitch法律小助手',
  ...
  auth: {
    ...
    firstTime: 'New to ChatSwitch法律小助手?',
  ...
  createChat: {
    title: 'Hi, I am ChatSwitch法律小助手, here to help solve legal problems',
...
\
  ...
  system: {
    ...
    deployUpdateLabel: 'Deployment update',
    deployUpdateDescription: 'Pull the current deploy template and latest Feishu images, then replace only changed managed services.',
    deployUpdateButton: 'Check and update deployment',
    deployUpdateCheckButton: 'Check updates',
    deployUpdateNoUpdate: 'This deployment is already up to date.',
    deployUpdateCheckFailed: 'Failed to check deployment updates',
    deployUpdateConfirmTitle: 'Update available',
    deployUpdateConfirmConfigChanged: 'Deployment configuration files have changed.',
    deployUpdateConfirmVersions: 'Image versions: {versions}.',
    deployUpdateConfirmServices: 'Services to replace: {services}.',
    deployUpdateConfirmProgressHint: 'After confirmation, new images will be pulled and the listed services will be replaced in the background. Check update-and-deploy.log in the deploy directory for progress.',
    deployUpdateConfirmRefreshHint: 'If frontend or backend services are replaced, the page may be briefly unavailable. Wait a while and refresh the page manually.',
    deployUpdateConfirmButton: 'Update',
    deployUpdateStarted: 'Deployment update started. New images are being pulled and services replaced in the background; refresh the page manually later.',
    deployUpdateFailed: 'Deployment update failed',
    deployUpdateSameVersionChanged: ' (same tag has newer image content)',
    deployUpdateProgressTitle: 'Deployment update progress',
    deployUpdateProgressHint: 'Reading the deployment log. Image pulls, container replacement, and readiness waits appear here. If frontend or backend services are being replaced, the page may be briefly unavailable; wait a while and refresh manually.',
    deployUpdateProgressWaiting: 'Waiting for deployment log...',
    deployUpdateLogFailed: 'Failed to read deployment log',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        models: {
          ...
          description: "Actual model-service concurrency from background tasks. This is the background throttle budget, not the total vLLM service slots.",
          scope: "Background active is cluster-wide · waiting is local",
          ...
          columns: { model: "Model ID", active: "Background in flight", waiting: "Background throttled", usage: "Background concurrency" },
        ...
        queueDescriptions: {
          default: "Document parsing and manual updates",
          postprocess: "Parse finalization and enrichment task fan-out",
