export default {
  legalWorkspace: {
    ...
    resources: 'Ресурсы',
    newChat: 'Новый чат',
    aiAssistant: 'Юридический помощник',
  ...
  documentDrafting: {
    ...
    debug: { open: 'Диагностика выполнения', back: 'К деталям задачи', title: 'Диагностика выполнения', eyebrow: 'Наблюдаемость и сравнение режимов', loading: 'Загрузка диагностики…', loadFailed: 'Не удалось загрузить диагностику', compare: 'Сравнить режимы', mode: 'Режим', model: 'Модель планирования', duration: 'Общее время', stageUnit: 'этапов', notRecorded: 'При создании этой задачи полный журнал не записывался. Доступные планы, операции и результаты показаны ниже.', timeline: 'Этапы выполнения', autoRefreshing: 'Обновление каждые 2 секунды', terminal: 'Задача завершена', attempt: 'Попытка {count}', sourceEngine: 'Исходный движок', characters: 'Число символов', truncated: 'Обрезано', yes: 'Да', no: 'Нет', loadSnapshot: 'Загрузить снимок текста', expandToLoad: 'Текст загружается по запросу', operationUnit: 'операций', kind: 'Тип', result: 'Результат', planJson: 'Plan JSON', resultAnalysis: 'Анализ результата', artifactUnit: 'результатов', artifacts: 'Результаты', validation: 'Проверка', loadDiff: 'Загрузить diff source / clean', loadingDiff: 'Создание diff…', diffNotRecorded: 'Снимок clean-текста не был записан.', comparison: 'Сравнение режимов', newComparison: 'Новое сравнение', strategy: 'Стратегия', sourceTask: 'Исходная задача', openTask: 'Открыть диагностику', noComparison: 'Сравнения режимов пока нет.', compareTitle: 'Сравнить режимы с одинаковыми входными данными', compareHint: 'Файл, инструкция и модель остаются неизменными.', replanHint: 'Каждый режим выполняет Inspect и создает свой Plan.', lockedHint: 'Использовать исходный Plan и сравнить только Worker; несовместимый запрос будет отклонен.', modes: 'Режимы', startComparison: 'Начать сравнение', startingComparison: 'Создание…', compareFailed: 'Не удалось создать сравнение.', blobLoadFailed: 'Не удалось загрузить защищенные отладочные данные.' },
    eyebrow: 'Юридическое рабочее пространство', title: 'Подготовка договора', subtitle: 'Загрузите DOCX и получите редактируемый результат по запросу на естественном языке.', newTask: 'Новая задача', file: 'Файл DOCX', instruction: 'Запрос на изменение', instructionPlaceholder: 'Например: изменить срок оплаты на 30 дней после получения счета и добавить комментарий.', mode: 'Режим движка', modeHint: 'Hybrid создает правки, а OfficeCLI проверяет и показывает результат.', officeCliLimit: 'OfficeCLI поддерживает только clean-версию, без правок и комментариев.', start: 'Запустить', submitting: 'Отправка…', refresh: 'Обновить', capabilities: 'Возможности Worker', capabilityHint: 'XLSX/PPTX пока недоступны.', tasks: 'Задачи', taskCount: 'Задач: {count}', loadingTasks: 'Загрузка задач…', empty: 'Задач пока нет', emptyDescription: 'После создания задачи здесь появятся ее статус и результаты.', noMatches: 'Нет задач, соответствующих фильтрам', searchPlaceholder: 'Поиск по имени файла или запросу', dateFrom: 'Начальная дата', dateTo: 'Конечная дата', modeFilter: 'Фильтр по режиму', allModes: 'Все режимы', allStatuses: 'Все статусы', selectedStatuses: 'Статусы: {count}/5', clearFilters: 'Сбросить фильтры', document: 'Документ', statusLabel: 'Статус', outputs: 'Результаты', updated: 'Обновлено', artifactCount: 'Результатов: {count}', details: 'Подробнее', taskDetails: 'Детали задачи', taskId: 'ID задачи', copyTaskId: 'Копировать ID задачи', taskIdCopied: 'ID задачи скопирован', backToTasks: 'Вернуться к задачам', loadingDetail: 'Загрузка деталей задачи…', detailLoadFailed: 'Не удалось загрузить детали задачи', previewReady: 'Предпросмотр документа готов', previewUnavailable: 'Предпросмотр недоступен', previewHint: 'Загрузите render-результат по требованию.', previewUnavailableHint: 'У задачи нет render-результата для просмотра.', loadPreview: 'Загрузить предпросмотр', previewLoadFailed: 'Не удалось загрузить предпросмотр.', operationCount: 'Операций: {count}', fileInfo: 'Информация о файле', fileSize: 'Размер файла', timeline: 'Хронология', created: 'Создано', started: 'Запущено', completed: 'Завершено', errorDetails: 'Сведения об ошибке', download: 'Скачать', noArtifacts: 'Нет доступных результатов', loadingPreview: 'Загрузка предпросмотра…', operations: 'Операции', noOperations: 'Нет записей об операциях', retry: 'Повторить', loadFailed: 'Не удалось загрузить задачи.', submitFailed: 'Не удалось создать задачу.', downloadFailed: 'Не удалось скачать результат.', cancel: 'Отменить задачу', cancelFailed: 'Не удалось отменить задачу.', status: { queued: 'В очереди', running: 'Выполняется', completed: 'Готово', failed: 'Ошибка', cancelled: 'Отменено' }
  },
  smartArchive: {
    deleteNotification: 'Удалить уведомление', deleteNotificationConfirm: 'Удалить это уведомление?', notificationUpdateFailed: 'Не удалось обновить уведомление.', notificationDeleteFailed: 'Не удалось удалить уведомление.',
    selectAll: 'Выбрать все в списке', selectedCount: 'Выбрано: {count}', bulkArchive: 'Архивировать выбранные', bulkRestore: 'Восстановить выбранные', bulkDelete: 'Удалить навсегда', bulkArchiveConfirm: 'Архивировать выбранные документы ({count})?', bulkRestoreConfirm: 'Восстановить выбранные документы ({count})?', bulkDeleteConfirm: 'Удалить выбранные документы навсегда? Их нельзя будет восстановить, связанные напоминания будут отменены.', bulkActionSuccess: 'Обработано документов: {count}.', bulkActionPartial: 'Обработано: {succeeded}, ошибок: {failed}. Обновите список для проверки.', bulkActionFailed: 'Не удалось выполнить массовую операцию.',
    bulkDeleteReminders: 'Удалить напоминания', bulkDeleteRemindersConfirm: 'Удалить выбранные напоминания ({count})?', bulkDeleteRemindersActiveConfirm: 'Среди выбранных есть {active} запланированных напоминаний. Удаление немедленно остановит будущие уведомления. Продолжить?', bulkDeleteRemindersSuccess: 'Удалено напоминаний: {count}.', bulkIgnoreCandidates: 'Игнорировать выбранные', bulkIgnoreCandidatesConfirm: 'Игнорировать выбранные элементы ({count})? Напоминания созданы не будут, записи сохранятся.', bulkIgnoreCandidatesSuccess: 'Проигнорировано элементов: {count}.',
    eyebrow: 'Архив', title: 'Архив договоров', subtitle: 'Храните документы, данные клиентов и важные даты.', importFiles: 'Импортировать файлы', importing: 'Импорт', importStarted: 'Импорт запущен.', importFailed: 'Ошибка импорта.', invalidFiles: 'Неподдерживаемые файлы пропущены. Поддерживаются PDF, Word, Excel, JPG, PNG и WEBP.', loading: 'Загрузка…', loadFailed: 'Не удалось загрузить архив.', searchFailed: 'Ошибка поиска.', documents: 'Документы', documentCount: 'Документов: {count}', documentsDescription: 'Договоры, займы, отгрузки и источники, включая OCR изображений.', customers: 'Клиенты', customersDescription: 'Клиенты из документов.', reminders: 'Напоминания', remindersDescription: 'Сначала подтвердите дату, затем создайте и включите напоминание.', candidatesTitle: 'Что нужно подтвердить', candidatesDescription: 'Найденные сроки — только предложения; напоминания автоматически не создаются.', noCandidates: 'Нет элементов для подтверждения', candidateNeedsReview: 'Сначала проверьте поле', candidateReview: 'Подтвердить напоминание', createReminder: 'Создать напоминание', reminderCreated: 'Напоминание создано. Включите его, когда будете готовы.', offsetDays: 'Дней заранее', reminderTime: 'Время напоминания', assignee: 'Ответственный', assigneeDefault: 'Ответственный по умолчанию', eventDate: 'Дата события', suggestedReminderDate: 'Рекомендуемая дата', returnDue: 'Срок возврата', cancel: 'Отмена', reviewQueue: 'Очередь проверки', reviewQueueDescription: 'Поля и связи документов для проверки.', searchPlaceholder: 'Введите запрос или номер соглашения', searchAction: 'Искать', dateFrom: 'Импортировано с', dateTo: 'Импортировано по', typeFilter: 'Фильтр по типу документа', allTypes: 'Все типы', allStatuses: 'Все статусы', selectedStatuses: 'Статусы: {count}/7', archiveView: 'Область архива', currentDocuments: 'Текущие документы', archivedDocuments: 'Архивные документы', showArchived: 'Показывать архив', clearFilters: 'Сбросить фильтры', noMatchingDocuments: 'Нет документов, соответствующих фильтрам.', loadMore: 'Загрузить ещё', loadedCount: 'Загружено {loaded} из {total}', emptyDocuments: 'Нет документов', emptyDocumentsDescription: 'Импортируйте PDF, Word, Excel, JPG, PNG, или WEBP для извлечения полей.', noEntities: 'Нет записей', noReminders: 'Созданных напоминаний нет', notifications: 'Уведомления', markRead: 'Прочитано', refresh: 'Обновить', reidentify: 'Распознать снова', document: 'Документ', type: 'Тип', customer: 'Клиент', relatedParty: 'Связанная сторона', status: 'Статус', updated: 'Обновлено', archive: 'Архивировать', archiveConfirm: 'Архивировать «{name}»?', restore: 'Восстановить', restoreConfirm: 'Восстановить «{name}»?', restoreFailed: 'Не удалось восстановить архивную запись.', delete: 'Удалить', deleteConfirm: 'Удалить «{name}»? Запись будет перемещена в корзину.', deleteFailed: 'Не удалось удалить архивную запись.', documentDetail: 'Детали документа', fileName: 'Имя файла', fileSize: 'Размер файла', importedAt: 'Импортировано', errorDetails: 'Сведения об ошибке', openOriginal: 'Открыть оригинал', agreementNumber: 'Номер соглашения', expiry: 'Срок', amount: 'Сумма', evidence: 'Доказательства полей', noEvidence: 'Нет доказательств', aliases: 'Алиасы', manual: 'Вручную', confidence: 'Уверенность', noDueDate: 'Дата не подтверждена', activate: 'Включить', handle: 'Обработано', reminderFailed: 'Не удалось обновить напоминание.', queueEmpty: 'Очередь пуста', queueEmptyDescription: 'Здесь появятся поля с низкой уверенностью.', noVerifiedFields: 'Проверяемые поля не найдены. Распознайте документ снова или проверьте вручную.', documentTypes: { contract: 'Договор', loan_agreement: 'Займ', outbound_order: 'Отгрузка', return_order: 'Возврат', renewal: 'Продление', payment: 'Платеж', delivery: 'Поставка', other: 'Другое' }, extractionStatuses: { uploading: 'Загрузка', parsing: 'Разбор', extracting: 'Извлечение', linking: 'Связь', needs_review: 'Проверка', completed: 'Готово', failed: 'Ошибка' }, reminderStatuses: { draft: 'Требует включения', active: 'Активно', snoozed: 'Отложено', handled: 'Обработано', canceled: 'Отменено' }
  },
  platformApiKeys: {
