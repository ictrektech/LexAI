export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в ChatSwitch法律小助手',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и ChatSwitch法律小助手 автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в ChatSwitch法律小助手',
  ...
  auth: {
    ...
    firstTime: 'Впервые в ChatSwitch法律小助手?',
  ...
  system: {
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        detailsDescription: "Текущая нагрузка и ожидание для каждого канала обработки.",
        poolsTitle: "Пулы воркеров",
        poolsDescription: "Основной разбор, обогащение, обслуживание и Wiki используют независимые бюджеты параллелизма.",
        perInstance: "Параллелизм указан на процесс",
        queueCount: "Очередей: {value}",
        weight: "Вес в пуле {value}",
        footnote: "Параллелизм указан на процесс и требует перезапуска; вес действует только внутри пула; активные задачи показаны по всему кластеру.",
        ...
        poolDescriptions: {
          core: "Разбор документов и оркестрация постобработки",
        ...
        queueNames: {
          default: "По умолчанию (парсинг документов)",
          summary: "Создание сводок",
          sync: "Синхронизация источников",
          low: "Фоновое обслуживание и пакетные задачи",
          multimodal: "Мультимодальные (изображения)",
          graph: "Извлечение графа",
          question: "Генерация вопросов",
          wiki: "Синхронизация Wiki",
        },
        queueDescriptions: {
          default: "Разбор документов, ручные обновления и оркестрация постобработки",
          summary: "Сводки документов и таблиц данных",
          sync: "Ручная и плановая синхронизация источников",
          low: "Импорт FAQ, клонирование/перемещение, пакетный повторный разбор и удаление",
          multimodal: "OCR изображений и мультимодальные описания",
          graph: "Извлечение графа знаний из фрагментов документов",
          question: "Генерация вопросов по фрагментам документов",
          wiki: "Создание содержимого Wiki и синхронизация индекса",
        },
      },
      keyLabels: {
        auth: {
        ...
        asynq: {
          concurrency: 'Общий бюджет фоновых воркеров',
      ...
      keyDescriptions: {
        ...
        asynq: {
          concurrency:
            'Общий бюджет параллелизма фоновых задач на процесс (без Wiki). Он делится на изолированные пулы: 1/2 основной разбор, 3/8 обогащение, остаток — обслуживание и синхронизация. Минимум 3; требуется перезапуск сервиса.',
          wiki_concurrency:
  ...
  createChat: {
    title: 'Привет, я ChatSwitch法律小助手, помогаю решать юридические вопросы',
