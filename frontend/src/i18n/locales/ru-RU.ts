export default {
  ...
  smartArchive: {
    selectAll: 'Выбрать все в списке', selectedCount: 'Выбрано: {count}', bulkArchive: 'Архивировать выбранные', bulkRestore: 'Восстановить выбранные', bulkDelete: 'Переместить в корзину', bulkArchiveConfirm: 'Архивировать выбранные документы ({count})?', bulkRestoreConfirm: 'Восстановить выбранные документы ({count})?', bulkDeleteConfirm: 'Переместить выбранные документы ({count}) в корзину? Связанные напоминания будут отменены.', bulkActionSuccess: 'Обработано документов: {count}.', bulkActionPartial: 'Обработано: {succeeded}, ошибок: {failed}. Обновите список для проверки.', bulkActionFailed: 'Не удалось выполнить массовую операцию.',
