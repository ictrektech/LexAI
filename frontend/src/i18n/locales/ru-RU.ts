export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в LexAI Legal Assistant',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и LexAI Legal Assistant автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в LexAI Legal Assistant',
  ...
  auth: {
    ...
    firstTime: 'Впервые в LexAI Legal Assistant?',
  ...
  createChat: {
    title: 'Привет, я LexAI Legal Assistant, помогаю решать юридические вопросы',
