  ...
  system: {
    ...
    globalSettings: {
      ...
      sections: {
        ...
        tenant: {
          tab: 'Значения тенанта {count}',
          title: 'Значения тенанта по умолчанию',
          description: 'Начальные квоты и режимы совместимости для новых тенантов.',
        },
        runtime: {
      ...
      runtime: {
        ...
        queueDescriptions: {
          default: "Разбор документов и ручные обновления",
          postprocess: "Завершение разбора и запуск задач обогащения",
      ...
      keyLabels: {
        ...
        tenant: {
          ...
          auto_create_api_key: 'Автоматически создавать API-ключ для новых тенантов',
        },
        asynq: {
      ...
      keyDescriptions: {
        ...
        tenant: {
          ...
          self_service_creation_enabled:
            'Разрешает обычным пользователям самостоятельно создавать пространства. Если отключено, они могут только присоединяться по приглашению; межтенантные суперпользователи не ограничены.',
          ...
          auto_create_api_key:
            'Автоматически создаёт API-ключ full_access и возвращает его открытый токен при создании тенанта. Включайте только для старых интеграций; по умолчанию отключено.',
        },
        asynq: {
