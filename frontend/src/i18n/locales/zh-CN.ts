export default {
  ...
  documentDrafting: {
    preview: '页面预览',
    eyebrow: '法律工作台', title: '合同起草', subtitle: '上传 DOCX，用自然语言生成可审阅的修改结果。', newTask: '新建起草任务', file: 'DOCX 文件', instruction: '修改要求', instructionPlaceholder: '例如：将付款期限改为收到发票后 30 日内，并为该修改添加评论。', mode: '执行模式', modeHint: 'Hybrid 由 Adeu 生成修订，再由 OfficeCLI 做验证和预览。', officeCliLimit: 'OfficeCLI 仅输出 clean 版本，不支持修订和评论。', start: '开始生成', submitting: '提交中…', refresh: '刷新', capabilities: 'Worker 能力', capabilityHint: 'XLSX/PPTX 暂未开放；Worker 缺失时不会影响其他法律功能。', tasks: '任务记录', taskCount: '{count} 个任务', loadingTasks: '正在加载任务…', empty: '暂无起草任务', emptyDescription: '创建任务后，执行状态和产物会显示在这里。', noMatches: '没有符合筛选条件的任务', searchPlaceholder: '搜索文件名或修改要求', dateFrom: '开始日期', dateTo: '结束日期', modeFilter: '按执行模式筛选', allModes: '全部模式', allStatuses: '全部状态', selectedStatuses: '状态 {count}/5', clearFilters: '清除筛选', document: '文档', statusLabel: '状态', outputs: '产物', updated: '更新时间', artifactCount: '{count} 个产物', details: '查看详情', taskDetails: '任务详情', taskId: '任务 ID', copyTaskId: '复制任务 ID', taskIdCopied: '任务 ID 已复制', backToTasks: '返回任务记录', loadingDetail: '正在加载任务详情…', detailLoadFailed: '无法加载任务详情', previewReady: '文档预览已就绪', previewUnavailable: '暂无文档预览', previewHint: '点击后按需加载 render 产物。', previewUnavailableHint: '此任务没有可预览的 render 产物。', loadPreview: '加载预览', previewLoadFailed: '预览加载失败。', operationCount: '{count} 个操作', fileInfo: '文件信息', fileSize: '文件大小', timeline: '执行时间线', created: '已创建', started: '已开始', completed: '已完成', errorDetails: '错误详情', download: '下载', noArtifacts: '暂无可用产物', loadingPreview: '正在加载预览…', operations: '执行操作', noOperations: '暂无操作记录', retry: '重试', loadFailed: '无法加载起草任务。', submitFailed: '无法创建起草任务。', downloadFailed: '产物下载失败。', cancel: '取消任务', cancelFailed: '取消任务失败。', debug: { open: '执行诊断', back: '返回任务详情', title: '执行诊断', eyebrow: '可观测性与模式评估', loading: '正在加载执行诊断…', loadFailed: '无法加载执行诊断', compare: '对比模式', mode: '执行模式', model: '规划模型', duration: '总耗时', stageUnit: '个阶段', notRecorded: '该任务创建时未记录完整执行轨迹；仍展示现有 Plan、操作和产物。', timeline: '阶段时间线', autoRefreshing: '每 2 秒自动刷新', terminal: '任务已进入终态', attempt: '第 {count} 次尝试', sourceEngine: '来源引擎', characters: '原始字符数', truncated: '是否截断', yes: '是', no: '否', loadSnapshot: '加载文本快照', expandToLoad: '文本仅在点击后加载', operationUnit: '个操作', kind: '类型', result: '结果', planJson: 'Plan JSON', resultAnalysis: '结果分析', artifactUnit: '个产物', artifacts: '产物摘要', validation: '验证摘要', loadDiff: '加载 source / clean 文本 Diff', loadingDiff: '正在生成 Diff…', diffNotRecorded: '该任务未记录 clean 文本快照，无法生成文本 Diff。', comparison: '模式对比', newComparison: '新建对比', strategy: '对比策略', sourceTask: '源任务', openTask: '打开诊断', noComparison: '尚未创建模式对比。', compareTitle: '使用相同输入对比执行模式', compareHint: '源文件、修改要求和模型保持不变。', replanHint: '每种模式自行 Inspect 并重新规划。', lockedHint: '复用原 Plan，仅比较 Worker；不兼容时整体拒绝。', modes: '执行模式', startComparison: '开始对比', startingComparison: '正在创建…', compareFailed: '无法创建模式对比。', blobLoadFailed: '无法加载调试原文。' }, status: { queued: '排队中', running: '执行中', completed: '已完成', failed: '失败', cancelled: '已取消' }
  },
  smartArchive: {
    deleteNotification: '删除通知', deleteNotificationConfirm: '确定删除这条通知吗？', notificationUpdateFailed: '通知状态更新失败。', notificationDeleteFailed: '通知删除失败。',
    eyebrow: '档案工作台', title: '智能档案', subtitle: '让海量合同可搜索、可定位、可追溯，并及时提醒关键事项', importFiles: '批量导入', importing: '正在导入', importStarted: '导入任务已创建。', importFailed: '导入失败。', invalidFiles: '已跳过不支持的文件类型（支持 PDF、Word、Excel、JPG、PNG、WEBP）。', loading: '正在加载…', loadFailed: '档案加载失败。', searchFailed: '检索失败。', documents: '文档', documentCount: '{count} 份文档', documentsDescription: '合同、借用协议、出库单及其原文证据。支持图片 OCR。', customers: '客户', customersDescription: '从历史文档归一化的客户档案。', reminders: '提醒', remindersDescription: '先确认事项，再创建和启用提醒。', candidatesTitle: '待确认事项', candidatesDescription: '系统识别出的关键时间节点，不会自动创建提醒。', noCandidates: '暂无待确认事项', candidateNeedsReview: '需先复核字段', candidateReview: '确认提醒事项', createReminder: '创建提醒', reminderCreated: '提醒已创建，请确认后启用。', offsetDays: '提前天数', reminderTime: '提醒时间', assignee: '负责人', assigneeDefault: '默认负责人', eventDate: '事件日期', suggestedReminderDate: '建议提醒日期', returnDue: '应归还日', cancel: '取消', reviewQueue: '复核队列', reviewQueueDescription: '需要人工确认的字段和文档关联。', searchPlaceholder: '试试“去年与 XX 客户签订的合同”或输入协议编号', searchAction: '执行搜索', dateFrom: '导入开始日期', dateTo: '导入结束日期', typeFilter: '按文档类型筛选', allTypes: '全部类型', allStatuses: '全部状态', selectedStatuses: '状态 {count}/7', archiveView: '档案范围', currentDocuments: '当前文档', archivedDocuments: '已归档文档', showArchived: '显示已归档', clearFilters: '清除筛选', noMatchingDocuments: '没有符合筛选条件的档案文档。', loadMore: '加载更多', loadedCount: '已加载 {loaded}/{total}', selectAll: '全选当前列表', selectedCount: '已选 {count} 项', bulkArchive: '批量归档', bulkRestore: '批量恢复', bulkDelete: '永久删除', bulkArchiveConfirm: '确定归档选中的 {count} 份文档吗？', bulkRestoreConfirm: '确定恢复选中的 {count} 份文档吗？', bulkDeleteConfirm: '确定永久删除选中的 {count} 份文档吗？删除后不可恢复，关联提醒也会取消。', bulkActionSuccess: '已处理 {count} 份文档。', bulkActionPartial: '已处理 {succeeded} 份，{failed} 份失败，请刷新列表查看。', bulkActionFailed: '批量操作失败。', bulkDeleteReminders: '批量删除提醒', bulkDeleteRemindersConfirm: '确定删除选中的 {count} 条提醒吗？', bulkDeleteRemindersActiveConfirm: '选中的 {count} 条提醒中有 {active} 条正在调度，删除后会立即停止提醒。确定继续吗？', bulkDeleteRemindersSuccess: '已删除 {count} 条提醒。', bulkIgnoreCandidates: '批量忽略', bulkIgnoreCandidatesConfirm: '确定忽略选中的 {count} 项待确认事项吗？忽略后不会创建提醒，但记录会保留。', bulkIgnoreCandidatesSuccess: '已忽略 {count} 项待确认事项。', emptyDocuments: '暂无档案文档', emptyDocumentsDescription: '批量导入 PDF、Word、Excel 或 JPG/PNG/WEBP 图片，系统会自动解析并抽取字段。', noEntities: '暂无记录', noReminders: '暂无已创建提醒', notifications: '站内通知', markRead: '标为已读', refresh: '刷新', reidentify: '重新识别', document: '文档', type: '类型', customer: '客户', relatedParty: '关联主体', status: '状态', updated: '更新时间', archive: '归档', archiveConfirm: '确定归档“{name}”吗？', restore: '恢复', restoreConfirm: '确定恢复“{name}”吗？', restoreFailed: '恢复档案失败。', delete: '删除', deleteConfirm: '确定删除“{name}”吗？删除后将进入回收站。', deleteFailed: '删除档案失败。', documentDetail: '文档详情', fileName: '文件名', fileSize: '文件大小', importedAt: '导入时间', errorDetails: '错误详情', openOriginal: '打开原文', agreementNumber: '协议编号', expiry: '到期日', amount: '金额', evidence: '字段证据', noEvidence: '暂无字段证据', aliases: '别名', manual: '人工修正', confidence: '置信度', noDueDate: '待确认日期', activate: '启用', handle: '已处理', reminderFailed: '提醒更新失败。', queueEmpty: '复核队列为空', queueEmptyDescription: '低置信度字段会显示在这里。', noVerifiedFields: '未识别到可验证字段，请检查图片清晰度或重新识别。', documentTypes: { contract: '合同', loan_agreement: '借用协议', outbound_order: '出库单', return_order: '归还单', renewal: '续约文件', payment: '付款记录', delivery: '交付记录', other: '其他' }, extractionStatuses: { uploading: '上传中', parsing: '解析中', extracting: '抽取中', linking: '关联中', needs_review: '待复核', completed: '已完成', failed: '失败' }, reminderStatuses: { draft: '待启用', active: '已启用', snoozed: '已延期', handled: '已处理', canceled: '已取消' }
  },
  platformApiKeys: {
    title: '平台 API Key',
