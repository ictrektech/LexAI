export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "欢迎使用 ChatSwitch法律小助手",
        desc: "只需几步，带你快速了解知识库、对话与智能体的核心用法。点击「下一步」开始。",
      },
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，ChatSwitch法律小助手会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  knowledgeBase: {
    ...
    deleteSubmitted: "已提交删除任务",
    batchDeleteSuccess: "成功删除 {count} 个文档",
    batchDeleteSubmitted: "已提交 {count} 个文档删除任务",
    batchDeleteFailed: "批量删除失败",
    batchDownload: "下载选中文档",
  ...
  graphSettings: {
    ...
    templateUploaded: "模板已上传",
    templateUploadFailed: "模板上传失败，请检查 JSON 格式",
  ...
  auth: {
    ...
    firstTime: "首次使用 ChatSwitch法律小助手？",
  ...
  system: {
    ...
    deployUpdateLabel: "部署更新",
    deployUpdateDescription: "拉取当前部署模板和飞书最新镜像，只替换有变化的受管服务。",
    deployUpdateButton: "检查并更新部署",
    deployUpdateCheckButton: "检测更新",
    deployUpdateNoUpdate: "当前部署已是最新版本",
    deployUpdateCheckFailed: "检测部署更新失败",
    deployUpdateConfirmTitle: "发现可用更新",
    deployUpdateConfirmConfigChanged: "部署配置文件有更新。",
    deployUpdateConfirmVersions: "镜像版本：{versions}。",
    deployUpdateConfirmServices: "将替换服务：{services}。",
    deployUpdateConfirmProgressHint: "确认后会在后台拉取新镜像并替换上述服务，可在部署目录 update-and-deploy.log 查看进度。",
    deployUpdateConfirmRefreshHint: "如果前端或后端被替换，页面可能短暂不可用；请等待一段时间后手动刷新页面。",
    deployUpdateConfirmButton: "确认更新",
    deployUpdateStarted: "部署更新已启动，正在后台拉取新镜像并替换服务；请稍后手动刷新页面",
    deployUpdateFailed: "部署更新失败",
    deployUpdateSameVersionChanged: "（同版本镜像内容有更新）",
    deployUpdateProgressTitle: "部署更新进度",
    deployUpdateProgressHint: "正在读取部署日志。拉取镜像、替换容器和等待服务就绪的过程会显示在这里；如果前端或后端正在替换，页面可能短暂不可用，请等待一段时间后手动刷新。",
    deployUpdateProgressWaiting: "等待部署日志...",
    deployUpdateLogFailed: "读取部署日志失败",
  ...
  createChat: {
    title: "Hi，我是 ChatSwitch法律小助手，专门帮你解决法律问题",
    newSessionTitle: "新会话",
    messages: {
