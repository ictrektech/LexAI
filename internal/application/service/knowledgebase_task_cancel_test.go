...
func (r *recordingKBTaskInspector) CancelTasksForKnowledgeTypes(
	context.Context,
	string,
	[]string,
) (int, int, error) {
...
func (r *recordingKBTaskInspector) HasQueuedTasksForKnowledgeAttempt(context.Context, string, int) (bool, error) {
	return false, nil
}
